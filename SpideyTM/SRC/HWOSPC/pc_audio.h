...
/*-------------------------------------------------------------------------------------------------------
  ...
  Copied from
  XB_AUDIO.H - XB implementation of sound module.
...
//private:
  ...
  std::list<sound_instance *> instance_list;
...
private:
  ...
  std::list<sound_instance *> sound_list;
...
public:
  ...
  std::list<sound_emitter *>::iterator  release_emitter(sound_emitter* se);
...
public:
  ...
  std::list<sound_emitter *> emitter_list;

  // Emitters awaiting ressurection
  std::list<sound_emitter *> emitter_purgatory;

  // Master instance list
  std::list<sound_instance *> instance_list;

  // Instances awaiting the reaper
  std::list<sound_instance *> instance_death_row;

  // Instances awaiting resurrection
  std::list<sound_instance *> instance_purgatory;
