...
static std::list<sound_instance *> playback_pending_list;
...
/*** release_emitter ***/
std::list<sound_emitter *>::iterator sound_device::release_emitter(sound_emitter* se)
{/*
  if (!os_developer_options::inst()->is_flagged(os_developer_options::FLAG_NO_AUDIO))
  {
