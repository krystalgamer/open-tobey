...
protected:
  ...
  std::map<stringx,std::vector< anim_info >,s_t_s_t_r> anim_info_id_map;
...
public:
  typedef std::map<stringx,std::vector< anim_info >,s_t_s_t_r>::iterator anim_info_id_map_iterator;
  typedef std::vector< anim_info >::iterator anim_info_id_map_anims_iterator;

  typedef std::map<stringx,std::vector< anim_info >,s_t_s_t_r>::const_iterator anim_info_id_map_const_iterator;
  typedef std::vector< anim_info >::const_iterator anim_info_id_map_anims_const_iterator;

  const std::map<stringx,std::vector< anim_info >,s_t_s_t_r> &get_anim_info_id_map() const { return(anim_info_id_map); }
