...
public:
  ...
  typedef binary_tree<_Partition> _Tr;
	...
	std::vector<partition3 *> plane_stack;


  // CLASS iterator
  class iterator;
  friend class iterator;
  class iterator : public std::bidirectional_iterator<_Partition,difference_type
#ifdef TARGET_XBOX
...
//    float f2 = 5/f1;
  ...
  typedef std::vector<_Partition *> plane_list_t;
  typedef std::vector<int> hit_dir_list_t;
  typedef std::vector<_Portion> hit_list_t;
