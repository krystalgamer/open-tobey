...
class bsp_tree : public bp_tree<_Partition,_Portion>
{
  ...
  public:
    ...
    typedef std::bidirectional_iterator<bp_tree<_Partition,_Portion>::value_type,bp_tree<_Partition,_Portion>::difference_type
#ifdef TARGET_XBOX
  ...
  class branch_vector: public std::vector<tree_t::branch>
