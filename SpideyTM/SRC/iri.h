...
public:
  ...
  instance_render_info(
          ...
          std::vector<material*> *_alt_materials = NULL
          )
  ...
  std::vector<material*>       *get_alt_materials() const { return alt_materials;}
  void                    set_alt_materials( std::vector<material*> *_alt_materials ) { alt_materials = _alt_materials;}
