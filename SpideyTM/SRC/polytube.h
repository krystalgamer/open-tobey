...
public:
  ...
  inline const std::vector<vector3d> &get_control_pts() const                          { return(spline.get_control_pts()); }
  inline const std::vector<vector3d> &get_curve_pts() const                            { return(spline.get_curve_pts()); }
...
void render_polytube(const std::vector<vector3d> &pts, rational_t radius, int num_sides = 3, const color32 &col = color32_white, mat_fac *the_material = NULL, rational_t tiles_per_meter = 1.0f, const matrix4x4 &the_matrix = identity_matrix, rational_t max_length = -1.0f);
inline void render_polytube(const std::vector<vector3d> &pts, rational_t radius, int num_sides = 3, const color32 &col = color32_white, mat_fac *the_material = NULL, rational_t tiles_per_meter = 1.0f, const po &the_po = po_identity_matrix, rational_t max_length = -1.0f)
{
